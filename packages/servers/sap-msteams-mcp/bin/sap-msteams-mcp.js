...
function showHelp() {
  console.log(`
SAP MS Teams MCP Server v${packageJson.version}
${packageJson.description}

Usage:
  sap-msteams-mcp [options]
...
Examples:
  ...
  echo '{"method":"tools/list"}' | sap-msteams-mcp

Environment Variables:
  AUTH_COOKIE_DIR      Directory to store authentication cookies (default: ~/.sap-auth-mcp)
