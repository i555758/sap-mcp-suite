...
function showHelp() {
  console.log(`
SAP Authentication MCP Server v${packageJson.version}
${packageJson.description}

Usage:
  sap-auth-mcp [options]
...
Examples:
  ...
  echo '{"method":"tools/list"}' | sap-auth-mcp
...
async function main() {
  ...
  try {
    console.error("🚀 Starting SAP Authentication MCP Server...");
    ...
    console.error("❌ Error starting SAP Authentication MCP Server:");
