...
function showHelp() {
  console.log(`
SAP Wiki MCP Server v${packageJson.version}
${packageJson.description}

Usage:
  sap-wiki-mcp [options]
...
Examples:
  ...
  echo '{"method":"tools/list"}' | sap-wiki-mcp
...
async function main() {
  ...
  try {
    console.error("🚀 Starting SAP Wiki MCP Server...");
    await import(serverPath);
  } catch (error) {
    console.error("❌ Error starting SAP Wiki MCP Server:");
